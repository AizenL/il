...
class SaleQuotationOrder(models.Model):
    ...
    def create(self, line_values):
        res = super(SaleQuotationOrder, self).create(line_values)
        res._reset_sequence()
        return res
    ...
    def write(self, line_values):
        res = super(SaleQuotationOrder, self).write(line_values)

        self._reset_sequence()

        return res

class SaleQuotationOrderLine(models.Model):
