openerp.pos_order_analysis = function (instance) {
    ...
    instance.pos_high_chart = instance.web.Widget.extend({
        ...
        start : function(){
            var self = this;
            self.pos_chart_customer = new instance.web.DataSetSearch(self, 'sale.order', {}, []);
            self.pos_chart_customer.read_slice(['id','partner_id'], {'domain': [['partner_id', '!=', false],['state','=','done']]}).done(function(records){
            ...
            self.pos_chart_product = new instance.web.DataSetSearch(self, 'sale.order.line', {}, []);
