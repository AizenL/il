...
class PurchaseOrder(models.Model):
    ...
    def create(self, line_values):
        res = super(PurchaseOrder, self).create(line_values)
        res._reset_sequence()
        return res
...
class PurchaseOrderLine(models.Model):
    ...
    sequence = fields.Integer('Sequence', help="Gives the sequence order when displaying a list of Purchase order lines.", default=99999)
